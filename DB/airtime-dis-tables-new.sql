...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2021 at 02:42 AM
...
(1, 1, 'Micheal', 'Iyanda', '2348160317722', 'NG', 'Nigeria', 'MTN Nigeria Communications Ltd', 'NGN', '2021-05-29 01:12:34'),
(2, 1, 'Boss test', 'Boss', '31638734411', 'NL', 'Netherlands', 'T-Mobile Netherlands BV', 'EUR', '2021-05-29 01:12:36'),
(3, 1, 'Micheal', 'Iyanda', '2348160317722', 'NG', 'Nigeria', 'MTN Nigeria Communications Ltd', 'NGN', '2021-05-29 01:32:11'),
(4, 1, 'Boss test', 'Boss', '31638734411', 'NL', 'Netherlands', 'T-Mobile Netherlands BV', 'EUR', '2021-05-29 01:32:13');
...
CREATE TABLE `setting` (
  ...
  `nx_pubkey` varchar(50) NOT NULL,
  `nx_seckey` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `setting` (`sn`, `af_username`, `af_apikey`, `nv_accesskey`, `nx_pubkey`, `nx_seckey`) VALUES
